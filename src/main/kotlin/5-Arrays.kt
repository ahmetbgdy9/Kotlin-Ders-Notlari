...
fun main() {
	...
	/**
	 * Genel olarak elimizde kümeleyebilecegimiz veri grupları varsa ve bunlari listelemek,goruntulemek istiyorsak,ya da üzerlerinde döngü döndürme,birşey arama gibi bu durumlarda arrayleri kullanabiliriz.
	...
	/**
	 *     emptyArray+= "Ahmet"
	 *     emptyArray2 = arrayOf("Ahmet")  Bu ikisi memory karsiliklarinda ayni anlama gelir.
	 */

//    emptyArray[0] = "Ahmet" Herhangi bir indeksi olmadigi icin bu islemi yapamayiz.ArrayIndexOutOfBoundsException hatasi aliriz.
	 ...
	 * Biz herhangi bir arraye(nasıl tanımlandıgı farketmez) yeni bir ekleme yapıyorsak,bu durumda mevcut durumdaki array'i refere etmeyi bırakır,onun yerine yeni bir array olusturur.
	 */
