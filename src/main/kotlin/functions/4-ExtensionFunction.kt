 ...
 *      Yapisal olarak;
 *
 *      fun String.extPrint(handsomeValue : HandsomeOne) : Unit { //Sadece onune hangi sinifi buyutmek istiyorsam onu yazip . koyuyoruz
 *
 *      }
 * **/
...
fun main() {
	...
	(3 + 0.14).log("pi")
	1341.log("int")
	18608268888.log("long")


	(3 + 0.14) log "" // thanks infi
...
/*
* 	Infix extension fonksiyon, expression formda kullanılabilir.
 */
