...
fun main(): Unit {
	...
	getUserInfo1("Ahmet", "Bugday", "Türkiye", "İstanbul", "", "", "", key = 3)
	...
	getUserInfo1(*arrayOf("Ahmet", "Bugday", "İstanbul","Türkiye"), key = 3)

	getUserInfo2(*arrayOf("Ahmet", "Bugday", "İstanbul", "Türkiye"))

	getUserInfo3(key = 3, "Ahmet", "Bugday", "İstanbul", "Türkiye")

	getUserInfo4(3, "Ahmet", "Bugday", true, 3.14, "")

	println(getListCount())
	println(getListCount2())
	println(getListCount3())
