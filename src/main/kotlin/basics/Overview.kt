...
/**
 * Degiskenlerin kabaca iki turu vardir.
 * 1) Referans Tipli Degiskenler  ----  2) Primitive Tipli Degiskenler
 * Java ve diger bir cok dilde primitive gorurken, kotlinde baktigimizda tum degisken tipleri bir CLASS'dir.
 ...
 * Kotlinde her sey birer nesnedir. Yani buradaki class tipindeki desgiskenler calisma zamaninda yapilan organizasyonlarla java tarafindaki gercek primitive karsiliklarina donusturulurler.
 *
 * ShowKotlinByteCode yapip gorebiliriz.
 */
...
// user.name = "Ahmet"  Val oldugu icin zaten degeri degistirilemez.
//     user.surname = "Bugday" set fonksiyonunu private yaptigimiz icin degeri degistirilemez.
}